...
export const registerTeacher = async (req, res) => {
    const { name, email, password, firstName, lastName, employeeId, qualification, specialization, experience, joiningDate, designation, gender, dateOfBirth, phone, address, city, state, bloodGroup, bio, subjectId, // optional — single subject UUID
...
export const updateTeacher = async (req, res) => {
    ...
    const { firstName, lastName, designation, qualification, specialization, experience, joiningDate, gender, dateOfBirth, phone, address, city, state, bloodGroup, bio, email, status, subjectId, // replaces old subject assignment
