export const normalizeAssignmentsForStudent = (assignments) => {
    const now = new Date();
    return assignments.map((task) => {
        ...
        if (hasSubmitted) {
            ...
            const isDueToday = taskDueDate.getDate() === now.getDate() &&
            ...
            if (isDueToday) {
                ...
                const isDueTomorrow = taskDueDate.getDate() === tomorrow.getDate() &&
...
//# sourceMappingURL=assignmentNormalizer.js.map