    ...
    <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm flex flex-col gap-5">
      ...
      <div className="space-y-3">
        ...
        <div className="bg-gray-50/30 border border-gray-100 rounded-xl p-4">
          <span className="block text-gray-400 text-xs font-semibold tracking-wider uppercase mb-1">Class Teacher</span>
          <span className="font-semibold text-gray-900 text-sm">{teacherName}</span>
        </div>

        {/* Room Number */}
        <div className="bg-gray-50/30 border border-gray-100 rounded-xl p-4">
          <span className="block text-gray-400 text-xs font-semibold tracking-wider uppercase mb-1">Room Number</span>
          <span className="font-semibold text-gray-900 text-sm">{roomNumber}</span>
        </div>

        {/* Strength & Progress Bar */}
        <div className="bg-gray-50/30 border border-gray-100 rounded-xl p-4 flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <span className="text-gray-400 text-xs font-semibold tracking-wider uppercase">Total Class Strength</span>
            <span className="text-xs font-bold text-[#4285F4]">{percentage}%</span>
          </div>

          <div className="flex items-baseline mt-1.5">
            <span className="text-3xl font-bold text-gray-900">{strength}</span>
            <span className="text-gray-400 text-sm font-semibold ml-0.5">/{maxStrength}</span>
          </div>
