...
interface AdminTopPerformersCardProps {
  viewMode: "table" | "graph";
}

const performersTable: Performer[] = [
...
const performersGraph: Performer[] = [
  { rank: 1, name: "Riya Patel", rollNo: "002", marks: "20/20" },
  { rank: 2, name: "Kavya Mehta", rollNo: "017", marks: "19/20" },
  { rank: 3, name: "Vihaan Kumar", rollNo: "005", marks: "17/20" },
];

const AdminTopPerformersCard: React.FC<AdminTopPerformersCardProps> = ({ viewMode }) => {
  const currentPerformers = viewMode === "table" ? performersTable : performersGraph;
...
export default AdminTopPerformersCard;
