    ...
    >
      <div className="bg-white rounded-2xl border border-gray-100 max-w-md w-full shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 pb-6 flex flex-col items-center text-center">
          ...
          <h3 className="font-bold text-gray-900 text-lg leading-snug">Delete Subjects</h3>
          <p className="text-sm text-gray-500 mt-2 leading-relaxed">
            Are you sure you want to delete <span className="font-semibold text-gray-800">{count} {count === 1 ? "selected subject" : "selected subjects"}</span>? This action is permanent, will remove associated teaching assignments, and cannot be undone.
          </p>
        </div>
