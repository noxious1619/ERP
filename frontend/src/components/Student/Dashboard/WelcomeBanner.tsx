    ...
    <div className="relative rounded-[32px] overflow-hidden flex flex-col justify-center px-7 w-full h-[220px]  bg-linear-65 from-blue-600 to-white ">
      ...
      <div className="relative z-10 flex flex-col gap-2.5">
        <h1 className="text-white font-bold leading-tight text-[22px]">
          Hello, Ojas! Ready for today's <br /> classes?
        </h1>
        <p className="text-white/80 text-[13px]">
          You have 4 classes today. Your first lecture starts in 20 <br />{" "}
          minutes in Room 402.
        </p>
        <div>
          <button className="bg-white font-semibold rounded-full hover:bg-gray-100 transition-colors text-[13px] px-6 py-2.5 text-[#0ea5e9] mt-2 ">
            View Schedule
          </button>
        </div>
      </div>
