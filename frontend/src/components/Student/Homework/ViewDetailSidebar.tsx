...
export interface HomeworkTask {
  ...
  dueDate: string; // e.g. "Monday, May 22"
  dueTime: string; // e.g. "10:00 PM"
...
// ─── Month abbreviation from a date string ────────────────────────────────────
// "Monday, May 22" → "MAY"
...
const ViewDetailSidebar = ({ task, onClose }: ViewDetailSidebarProps) => {
  ...
  // Reset per-task state & trigger slide-in animation
  useEffect(() => {
    if (task) {
      setImgIndex(0);
      setExpanded(false);
    ...
    <>
      ...
      >
        ...
        >
          ...
          `}</style>
          <div className="vd-scroll space-y-8">
            {/* ── Teacher image carousel / empty state ── */}
                    ...
                    <>
                      <button
                        ...
                        className="
                          ...
                          h-8 w-8 flex items-center justify-center
                          rounded-full bg-white/85 shadow-md
                        ...
                        {images.map((_, i) => (
                          <button
                            ...
                            className={`
                              ...
                              ${i === imgIndex ? "w-5 bg-white" : "w-1.5 bg-white/55"}
                            `}
                          />
                        ))}
                      </div>
                ...
                <div className="flex flex-col items-center justify-center h-[170px] gap-3 px-6">
                  ...
                  <div className="relative w-16 h-16">
                    ...
                    <div className="absolute inset-0 rounded-xl bg-white border border-gray-200 shadow-sm flex items-center justify-center">
                      {/* magnifier icon matching screenshot */}
                      <svg
                        width="28"
                        height="28"
                        viewBox="0 0 24 24"
            ...
            {/* ── Attachment / student submission card ── */}
            <div className="rounded-2xl bg-[#F5F8FF] p-4">
              <h3 className="text-[12px] font-bold text-[#4F52A3] uppercase tracking-widest mb-3">
                Attachment
              </h3>

              {/* Thumbnails grid — visible when files are selected */}
              {uploads.length > 0 && (
                <div className="flex flex-wrap gap-2 mb-3">
                  ...
                  <button
                    ...
                    className="
                      h-[70px] w-[70px] rounded-xl
                      border-2 border-dashed border-[#4F52A3]/30
                      bg-white/60 flex items-center justify-center
                      hover:border-[#4F52A3]/60 hover:bg-white
                      transition text-[#4F52A3]/50
                    "
                  >
        ...
        <div className="px-5 pt-3 pb-6 shrink-0 border-t border-gray-100">
          <button
            ...
            className="
              ...
              hover:bg-[#3f4290] active:scale-[0.98]
              transition shadow
