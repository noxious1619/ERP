...
const TeacherResultStatsCard: React.FC = () => {
  // Donut values (relative to 100% total)
  // Pass: 80% (blue) -> stroke-dasharray="80 20" stroke-dashoffset="0"
  // Fail: 10% (red)  -> stroke-dasharray="10 90" stroke-dashoffset="-80"
  // Absent: 10% (black) -> stroke-dasharray="10 90" stroke-dashoffset="-90"
...
export default TeacherResultStatsCard;
