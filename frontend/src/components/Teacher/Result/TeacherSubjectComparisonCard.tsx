...
const TeacherSubjectComparisonCard: React.FC = () => {
  return (
    <div className="bg-white rounded-[24px] border border-[#EAECF0] p-6 shadow-sm w-full flex items-center justify-between gap-4">
      {/* Left side text info */}
      <div className="flex flex-col justify-between h-[110px] w-[120px] shrink-0 text-left">
        ...
        <div className="mt-auto">
          ...
          <span className="text-[13px] font-semibold text-gray-400 mt-1 block">
            Section - A
          </span>
        </div>
      </div>
...
export default TeacherSubjectComparisonCard;
