...
//  * PLACEHOLDER ASSETS
//  * ------------------------------------------------------------------
//  * Replace these two paths with your own files (same folder as this
//  * component, or update the path to wherever you keep static assets).
//  *
//  *  - LOGO_SRC          -> the school crest/logo (top of the right panel)
//  *  - ILLUSTRATION_SRC   -> the left-side illustration
//  *
//  * Nothing else in the component needs to change — just drop your
//  * images in and point these two constants at them.
//  * ------------------------------------------------------------------
//  */
...
//   return (
//     <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-blue-80 to-blue-100 p-6">
...
//         {/* -------------------- LEFT PANEL -------------------- */}
//         <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-50 to-blue-100 items-center justify-center p-10">
