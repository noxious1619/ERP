...
//                 className="w-full flex items-center justify-center gap-3 rounded-3xl bg-[#3A71FF]  py-4 text-white text-[18px] font-[600] hover:bg-[#2d5fd4] transition-colors shadow-[0px_8px_24px_rgba(58,113,255,0.3)] cursor-pointer"
//               >
//                 Create Notice
